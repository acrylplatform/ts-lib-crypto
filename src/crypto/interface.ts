...
export const MAIN_NET_CHAIN_ID = 65 // A
export const TEST_NET_CHAIN_ID = 75 // K
...
//TSeed is a union of types that could represent a Acryl seed.
...
/* Acryl Crypto is a collection of essential cryptography and hashing
   algorithms used by Acryl, protocol entities and binary structures. */
...
export interface IWavesCrypto<TDesiredOut extends TBinaryOut = TBase58> {
  ...
  //Seed encryption (Same algorithm as in Acryl client and acrylKeeper).
